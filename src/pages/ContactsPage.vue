        ...
        <div class="contacts__wrapper">
          <div class="contacts__left">
            <p class="contacts__left-description">
              I am interested in working on modern, cool projects. If you
              have questions or suggestions for me, feel free to contact me.
            </p>
          </div>
          <div class="contacts__right">
            ...
            <div class="contacts__right-mail">
              <a
                  href="mailto:a.opk152@yandex.ru"
                  class="mail-link contacts__right-link"
              >
                <svg
                    width="32"
                    height="32"
                ...
                a.opk152@yandex.ru</a
              >
            </div>
            <div class="contacts__right-telegram">
              <a
                  href="https://t.me/dvelx"
                  class="telegram-link contacts__right-link"
              >
                <svg
                    width="32"
                    height="32"
            ...
            <div class="contacts__right-linkedIn">
              <a
                  href="https://www.linkedin.com/in/dvelx/"
                  class="linked-in-link contacts__right-link"
              >
                <svg
                    width="32"
                    height="32"
